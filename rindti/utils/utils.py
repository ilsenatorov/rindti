...
def get_name(**kwargs):
    ...
    '''
    prot = 'PROT={prot_embed}:{prot_embed_dim}:{prot_hidden_dim}:{prot_dropout}'.format(
        **kwargs)
    drug = 'DRUG={drug_embed}:{drug_embed_dim}:{drug_hidden_dim}:{drug_dropout}'.format(
        **kwargs)
